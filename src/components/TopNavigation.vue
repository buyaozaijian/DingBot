<template>
  <div class="navigation-main">
    ...
    <div style="display:inline-flex;margin-left: auto; margin-right: 10px" >
      ...
      <span class="tds-site-nav-item-text" style="margin-top: 16px">CN</span>
    </div>
  </div>
</template>

<script>
// import {ServeAxios} from "@/axios";
...
.tds-icon-globe{
  ...
  overflow: hidden;
  text-indent: -9999px;
  transition: color .33s ease,transform .5s cubic-bezier(0.5,0,0,0.75);
}
</style>